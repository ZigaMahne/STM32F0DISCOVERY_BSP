/******************************************************************************
 * @file     vio_STM32F0DISCOVERY.c
 * @brief    Virtual I/O implementation for board STM32F0DISCOVERY
 * @version  V1.0.0
...
/*! \page vio_STM32F0DISCOVERY Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED green   (LD3)    | PC9
| vioLED1       | vioSignalOut.1 | LED blue    (LD4)    | PC8
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTC(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTC(8),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
